...
# Import from the graft package with error handling
try:
    from graft.genindices import sample_selection
    from graft.decompositions import feature_sel
    GENINDICES_AVAILABLE = True
except ImportError:
    GENINDICES_AVAILABLE = False

@unittest.skipUnless(GENINDICES_AVAILABLE, "genindices functionality not available - missing dependencies")
